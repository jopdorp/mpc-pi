...
#
# RESTORED, essentially unchanged, from an earlier version removed in
# de9326e "strip to the MPC side" - nothing about this needed updating
# for the desk rename, since it never referenced strip names.
#
#   cable 1 <-> the MPC: emulator virmidi, both directions, so a
