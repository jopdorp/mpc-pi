...
| `0051` | No prose header; patch begins with a diff hunk | Unspecified | Not stated | Not stated |
| `0052` | No prose header; patch begins with a diff hunk | Unspecified | Not stated | Not stated |
| `0053` | Open the sampling input at machine start | Host-side only | Always active | While idle, reads and discards both input channels so the OSD capture node exists before the firmware arms recording |
| `0054` | No prose header; patch begins with a diff hunk | Unspecified | Not stated | Not stated |
